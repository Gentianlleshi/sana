...
import UvaImg from "@/public/assets/colors/uvarossa-img.png";
interface GoToSecondButtonViewProps {
  onGoBack: () => void;
  onGoHome: () => void;
}
const UvarossaButtonView: React.FC<GoToSecondButtonViewProps> = ({
  onGoBack,
  onGoHome,
}) => {
  return (
    <div className="uvarossa-view font-Comfortaa h-screen w-full">
        ...
        <div className="tab-content h-full flex-[0_0_85%]">
          <div className="content-wrapper h-full ml-[30%] flex flex-col justify-center">
            <div className="flex items-center justify-between ml-[5vw]">
              <h2 className="text-[3.15vw] text-center text-[#746686] font-semibold">
                UVA ROSSA
              </h2>
              <button
                onClick={onGoBack}
            ...
            <div className="info-wrapper w-full mt-9 rounded-ss-[128px] rounded-ee-[128px] overflow-hidden">
              <div className="flex gap-x-[31px] bg-[#B7B4BC] portrait:gap-x-[20px]">
                <div>
                  <Image src={UvaImg} alt="camomilla-img" />
                </div>
