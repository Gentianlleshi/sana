...
const slides = [
  <div className="flex bg-[#F4F7F2]">
    ...
    <div className="flex flex-col justify-center ml-[50px] mr-[70px]">
      <p className="font-bold text-[#0A2B18] text-[2.24vh] leading-[3.24vh] tracking-[-2px]">
  ...
  <div className="flex bg-[#F4F7F2]">
    ...
    <div className="flex flex-col justify-center ml-[50px] mr-[85px]">
      <p className="font-bold text-[#0A2B18] text-[2.24vh] leading-[3.24vh] tracking-[-2px]">
  ...
  <div className="flex bg-[#F4F7F2]">
    ...
    <div className="flex flex-col justify-center ml-[50px] mr-[110px]">
      <p className="font-bold text-[#0A2B18] text-[2.24vh] leading-[3.24vh] tracking-[-2px]">
