...
import GinImg from "@/public/assets/colors/ginkgo-img.png";
interface GoToSecondButtonViewProps {
  onGoBack: () => void;
  onGoHome: () => void;
}
const GinkgoButtonView: React.FC<GoToSecondButtonViewProps> = ({
  onGoBack,
  onGoHome,
}) => {
  return (
    <div className="ginkgo-view font-Comfortaa h-screen w-full">
        ...
        <div className="tab-content h-full flex-[0_0_85%]">
          <div className="content-wrapper h-full ml-[30%] flex flex-col justify-center">
            ...
            <div className="info-wrapper w-full mt-9 rounded-ss-[128px] rounded-ee-[128px] overflow-hidden">
              <div className="flex gap-x-[31px] bg-[#A6C44C] portrait:gap-x-[20px]">
                <div>
                  <Image src={GinImg} alt="camomilla-img" />
                </div>
