...
import MirImg from "@/public/assets/colors/mirtillo-img.png";
interface GoToSecondButtonViewProps {
  onGoBack: () => void;
  onGoHome: () => void;
}
const MirtilloButtonView: React.FC<GoToSecondButtonViewProps> = ({
  onGoBack,
  onGoHome,
}) => {
  return (
    <div className="mirtillo-view font-Comfortaa h-screen w-full">
        ...
        <div className="tab-content h-full flex-[0_0_85%]">
          <div className="content-wrapper h-full ml-[30%] flex flex-col justify-center">
            <div className="flex items-center justify-between ml-[5vw]">
              <h2 className="text-[3.15vw] text-center text-[#6B75A0] font-semibold">
                MIRTILLO
              </h2>
              <button
                onClick={onGoBack}
            ...
            <div className="info-wrapper w-full mt-9 rounded-ss-[128px] rounded-ee-[128px] overflow-hidden">
              <div className="flex gap-x-[31px] bg-[#CACEF4] portrait:gap-x-[20px]">
                <div>
                  <Image src={MirImg} alt="camomilla-img" />
                </div>
                <div className="flex flex-col justify-center leading-[2vw] portrait:m-[20px] portrait:ml-0">
                  <div className="text-[1.8vw] font-semibold px-[20px] border-b-2 border-white pb-[14px]">
                    ...
                    <h3 className="text-[#6B75A0]">FRUTTO</h3>
                  </div>
...
export default MirtilloButtonView;
